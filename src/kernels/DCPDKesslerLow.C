 ...
 */
template<>
InputParameters validParams<DCPDKesslerLow>()
{
...
DCPDKesslerLow::DCPDKesslerLow(const InputParameters & parameters) :
...
Real DCPDKesslerLow::computeQpResidual()
{
...
Real DCPDKesslerLow::computeQpJacobian()
{
...
//
Real DCPDKesslerLow::computeQpOffDiagJacobian(unsigned int jvar)
{
