...
CureFormulaS1::CureFormulaS1(const InputParameters & parameters) :
...
Real CureFormulaS1::computeQpResidual()
{
  ...
  */
  return  -_test[_i][_qp]*_u[_qp]*pow((1-_u[_qp]),3); //i changed this

}

Real CureFormulaS1::computeQpJacobian()
{
  ...
  */
  ...
  return -_test[_i][_qp]*(pow((1-_u[_qp]),3) +3*_u[_qp]*pow((1-_u[_qp]),2))*_phi[_j][_qp]; 
}
