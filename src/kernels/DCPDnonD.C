...
//******************************************************
#include "DCPDnonD.h"
//Kessler paper, medium catalyst concentration
 ...
 */
template<>
InputParameters validParams<DCPDnonD>()
{
...
DCPDnonD::DCPDnonD(const InputParameters & parameters) :
...
_Ttrig(getParam<Real>("Ttrig")),_Tintl(getParam<Real>("Tintl"))

{}

Real DCPDnonD::computeQpResidual()
{
...
Real DCPDnonD::computeQpJacobian()
{
...
//
Real DCPDnonD::computeQpOffDiagJacobian(unsigned int jvar)
{
