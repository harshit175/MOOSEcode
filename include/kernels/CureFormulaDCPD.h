...
#ifndef CUREFORMULADCPD_H
#define CUREFORMULADCPD_H
 ...
 */
class CureFormulaDCPD : public Kernel
{
public:
   ...
   */
  CureFormulaDCPD(const InputParameters & parameters);
