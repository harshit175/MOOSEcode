...
#ifndef CUREFORMULAACR_H
#define CUREFORMULAACR_H
 ...
 */
class CureFormulaACR : public Kernel
{
public:
   ...
   */
  CureFormulaACR(const InputParameters & parameters);
